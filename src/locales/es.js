...
offline_banner: "Estás sin conexión — comprueba tu internet",
  ...
  welcome_title: "Bienvenido a PairFC",
  welcome_sub: "Encuentra al futbolista que jugó en ambos clubes. Inicia sesión para guardar tu puntuación y entrar en la clasificación — o empieza a jugar ya.",
  welcome_google: "Iniciar sesión con Google",
  welcome_continue: "Continuar sin iniciar sesión",
  welcome_redirecting: "Redirigiendo…",
  welcome_note: "Iniciar sesión es opcional. Puedes hacerlo en cualquier momento desde el menú superior.",
  profile_menu: "Perfil",
  profile_signed_in_as: "Sesión iniciada como:",
  profile_account: "Mi cuenta",
