...
offline_banner: "Estás sin conexión — comprueba tu internet",
  ...
  nick_sub: "Entrarás en la clasificación con este nombre. Puedes cambiarlo cuando quieras.",
  ...
  profile_sub: "Puedes cambiar tu apodo. Tu XP y tu posición se mantienen.",
  profile_save: "Guardar",
  profile_cancel: "Cancelar",
  profile_edit_tooltip: "Editar tu apodo",
  xp_lb_howto: "¿Cuánto XP da cada modo?",
  xp_lb_howto_cta: "Ver",
  xp_info_title: "Cómo Ganar XP",
  xp_info_sub: "Cada modo da XP distinto. ¡Sigue jugando para subir!",
  xp_info_marathon_name: "Maratón",
  xp_info_marathon_desc: "XP por cada acierto. Más en dificultad alta.",
  xp_info_marathon_val: "Fácil 1 · Medio 2 · Difícil 5",
  xp_info_daily_name: "Reto Diario",
  xp_info_daily_desc: "+3 por acierto, +10 al completar, +2 por día de racha.",
  xp_info_daily_val: "3 + 10 + racha",
  xp_info_duel_name: "Duelo",
  xp_info_duel_desc: "Vence a tu rival para ganar más XP.",
  xp_info_duel_val: "Victoria 15 · Derrota 2",
  xp_info_arena_name: "Arena",
  xp_info_arena_desc: "XP según tu puesto (salas de 3+ jugadores).",
  xp_info_arena_val: "1º 25 · 2º 18 · 3º 12 · resto 5",
  xp_info_footer: "La clasificación semanal se reinicia cada lunes. La de todos los tiempos se acumula siempre.",
  xp_info_close: "Entendido",
  xp_note_marathon: "{n} aciertos × {per} XP",
  xp_note_daily: "{correct} aciertos + completar + racha de {streak} días",
  xp_note_duel_win: "Recompensa por victoria",
  xp_note_duel_loss: "Recompensa por participar",
  race_rank_line: "Vas {rank}.º de {total} jugadores",
  race_target_name: "{rank}.º {name}",
  race_gap: "faltan {n} XP",
  race_keep_playing: "¡Sigue jugando y supéralo! 🔥",
  race_top_title: "¡Estás en lo más alto!",
  race_chaser: "{name} te sigue a {n} XP",
  race_see_leaderboard: "Ver clasificación",
