...
offline_banner: "Çevrimdışısın — internet bağlantını kontrol et",
  ...
  xp_result_rank: "Haftalık #{n}",
  xp_result_up: "basamak",
  xp_result_down: "basamak",
  xp_lb_subtitle: "Oynadıkça XP kazan, sıralamada yüksel",
  xp_lb_weekly: "Bu Hafta",
  xp_lb_alltime: "Tüm Zamanlar",
  xp_lb_empty: "Henüz kimse XP kazanmadı. İlk sen ol!",
  xp_lb_you: "(sen)",
  xp_lb_not_ranked: "Henüz ilk 100'de değilsin — oynamaya devam et!",
  nick_title: "Bir takma ad seç",
  nick_sub: "Sıralamaya bu adla katılırsın. Sonra istediğin zaman değiştirebilirsin.",
  nick_placeholder: "Örn: KartalGözü",
  nick_hint: "3-20 karakter",
  nick_too_short: "En az 3 karakter olmalı",
  nick_too_long: "En fazla 20 karakter",
  nick_invalid: "Uygunsuz ifade kullanma",
  nick_taken: "Bu ad alınmış, başka dene",
  nick_error: "Bir hata oldu, tekrar dene",
  nick_saving: "Kaydediliyor…",
  nick_start: "Oyna",
  nick_note: "Takma ad cihazına bağlıdır; uygulamayı silersen sıfırlanır.",
  profile_title: "Profilin",
  profile_sub: "Takma adını değiştirebilirsin. XP'n ve sıralaman korunur.",
  profile_save: "Kaydet",
  profile_cancel: "Vazgeç",
  profile_edit_tooltip: "Takma adını düzenle",
  xp_lb_howto: "Hangi oyundan ne kadar XP kazanırsın?",
  xp_lb_howto_cta: "Öğren",
  xp_info_title: "XP Nasıl Kazanılır?",
  xp_info_sub: "Her oyun modu farklı XP verir. Oynadıkça yüksel!",
  xp_info_marathon_name: "Maraton",
  xp_info_marathon_desc: "Her doğru cevap için XP. Zorluk arttıkça artar.",
  xp_info_marathon_val: "Kolay 1 · Orta 2 · Zor 5",
  xp_info_daily_name: "Günlük Bulmaca",
  xp_info_daily_desc: "Her doğru +3, tamamlama +10, seri günü başına +2.",
  xp_info_daily_val: "3 + 10 + seri",
  xp_info_duel_name: "Düello",
  xp_info_duel_desc: "Rakibini yen, daha çok XP kazan.",
  xp_info_duel_val: "Galibiyet 15 · Mağlubiyet 2",
  xp_info_arena_name: "Arena",
  xp_info_arena_desc: "Sıralamana göre XP (en az 3 kişilik odalarda).",
  xp_info_arena_val: "1. 25 · 2. 18 · 3. 12 · diğer 5",
  xp_info_footer: "Haftalık sıralama her pazartesi sıfırlanır. Tüm zamanlar sıralaması hep birikir.",
  xp_info_close: "Anladım",
  xp_note_marathon: "{n} doğru × {per} XP",
  xp_note_daily: "{correct} doğru + tamamlama + {streak} gün seri",
  xp_note_duel_win: "Galibiyet ödülü",
  xp_note_duel_loss: "Katılım ödülü",
  race_rank_line: "{total} oyuncu arasında {rank}. sıradasın",
  race_target_name: "{rank}. {name}",
  race_gap: "{n} XP kaldı",
  race_keep_playing: "Oynamaya devam et, geç onu! 🔥",
  race_top_title: "Zirvedesin!",
  race_chaser: "{name} {n} XP geriden takip ediyor",
  race_see_leaderboard: "Sıralamayı gör",
