...
offline_banner: "Çevrimdışısın — internet bağlantını kontrol et",
  ...
  welcome_title: "PairFC'ye hoş geldin",
  welcome_sub: "İki kulüpte de oynamış futbolcuyu bul. Giriş yaparsan puanların kaydolur ve sıralamaya girersin — ya da hemen oynamaya başla.",
  welcome_google: "Google ile Giriş Yap",
  welcome_continue: "Giriş yapmadan devam et",
  welcome_redirecting: "Yönlendiriliyor…",
  welcome_note: "Giriş isteğe bağlıdır. İstediğin zaman üstteki menüden giriş yapabilirsin.",
  profile_menu: "Profil",
  profile_signed_in_as: "Giriş yapıldı:",
  profile_account: "Hesabım",
