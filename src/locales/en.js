...
offline_banner: "You're offline — check your connection",
  ...
  welcome_title: "Welcome to PairFC",
  welcome_sub: "Find the footballer who played for both clubs. Sign in to save your score and join the leaderboard — or just start playing.",
  welcome_google: "Sign in with Google",
  welcome_continue: "Continue without signing in",
  welcome_redirecting: "Redirecting…",
  welcome_note: "Signing in is optional. You can sign in anytime from the top menu.",
