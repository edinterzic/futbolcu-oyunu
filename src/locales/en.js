...
offline_banner: "You're offline — check your connection",
  ...
  xp_result_rank: "Weekly #{n}",
  xp_result_up: "up",
  xp_result_down: "down",
  xp_lb_subtitle: "Earn XP as you play, climb the ranks",
  xp_lb_weekly: "This Week",
  xp_lb_alltime: "All Time",
  xp_lb_empty: "No one has earned XP yet. Be the first!",
  xp_lb_you: "(you)",
  xp_lb_not_ranked: "You're not in the top 100 yet — keep playing!",
  nick_title: "Choose a nickname",
  nick_sub: "You'll join the leaderboard with this name. You can change it anytime later.",
  nick_placeholder: "e.g. EagleEye",
  nick_hint: "3-20 characters",
  nick_too_short: "At least 3 characters",
  nick_too_long: "Max 20 characters",
  nick_invalid: "No inappropriate words",
  nick_taken: "That name is taken, try another",
  nick_error: "Something went wrong, try again",
  nick_saving: "Saving…",
  nick_start: "Play",
  nick_note: "Your nickname is tied to this device; it resets if you delete the app.",
  profile_title: "Your Profile",
  profile_sub: "You can change your nickname. Your XP and rank stay safe.",
  profile_save: "Save",
  profile_cancel: "Cancel",
  profile_edit_tooltip: "Edit your nickname",
  xp_lb_howto: "How much XP does each mode give?",
  xp_lb_howto_cta: "Learn",
  xp_info_title: "How to Earn XP",
  xp_info_sub: "Each mode gives different XP. Keep playing to climb!",
  xp_info_marathon_name: "Marathon",
  xp_info_marathon_desc: "XP per correct answer. More on harder difficulty.",
  xp_info_marathon_val: "Easy 1 · Medium 2 · Hard 5",
  xp_info_daily_name: "Daily Puzzle",
  xp_info_daily_desc: "+3 per correct, +10 for completing, +2 per streak day.",
  xp_info_daily_val: "3 + 10 + streak",
  xp_info_duel_name: "Duel",
  xp_info_duel_desc: "Beat your opponent to earn more XP.",
  xp_info_duel_val: "Win 15 · Loss 2",
  xp_info_arena_name: "Arena",
  xp_info_arena_desc: "XP by finishing place (rooms of 3+ players).",
  xp_info_arena_val: "1st 25 · 2nd 18 · 3rd 12 · rest 5",
  xp_info_footer: "Weekly ranking resets every Monday. All-time ranking keeps building.",
  xp_info_close: "Got it",
  xp_note_marathon: "{n} correct × {per} XP",
  xp_note_daily: "{correct} correct + completion + {streak}-day streak",
  xp_note_duel_win: "Victory reward",
  xp_note_duel_loss: "Participation reward",
  race_rank_line: "You're #{rank} of {total} players",
  race_target_name: "#{rank} {name}",
  race_gap: "{n} XP to go",
  race_keep_playing: "Keep playing — pass them! 🔥",
  race_top_title: "You're on top!",
  race_chaser: "{name} is {n} XP behind you",
  race_see_leaderboard: "See leaderboard",
